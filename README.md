...
- [software-updates](./software-updates/README.md): Perform a **software update** of a confidential Python application. `API_PASSWORD` is generated by CAS (never visible to anyone) and preserved across the rolling update from Version 1 to Version 2 via `migrate: true` on the CAS session secret.
